                ...
                <div class="col-lg-8 mx-auto">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="tagname" class="form-control" id="tag" placeholder="Tag Name">
                        </div>
                        <div class="form-group">
                          <label for="tagdes">Description</label>
                          <textarea name="tagdes" class="form-control" id="tagdes" cols="30" rows="10" placeholder="Description"></textarea>
                        </div>
